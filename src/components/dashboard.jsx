...
const Dashboard = () => {
  ...
  const createNewGame = async () => {
    ...
    try {
      ...
      navigate(`/game/${newGameId}`);  // Navigate to game route instead of setting state
  ...
  const joinGame = async (gameId) => {
    try {
      ...
      navigate(`/game/${gameId}`);  // Navigate to game route instead of setting state
    } catch (error) {
