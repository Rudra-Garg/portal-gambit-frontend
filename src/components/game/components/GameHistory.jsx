...
const GameHistory = ({ moveHistory = [], portalMode, setPortalMode, isMyTurn, exit}) => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 flex-grow mb-2 rounded-lg border border-gray-200 shadow-inner flex flex-col" 
      ...
      <div className="overflow-y-auto p-3 flex-grow rounded-md border border-gray-200 shadow-inner bg-gray-50">
